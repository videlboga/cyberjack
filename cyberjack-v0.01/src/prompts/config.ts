...
export let activeConfig: PromptConfig = {
    ...
    adapters: {
        ...
        narratorInputPrompt: "Опиши реакцию их тел (до 3 предложений). Не называй эмоции или скрытые ощущения впрямую — показывай их через физические перемены (дрожь, дыхание, положение пальцев, губ, глаз). Не додумывай действия Калибратора."
    },
    orchestrator: {
