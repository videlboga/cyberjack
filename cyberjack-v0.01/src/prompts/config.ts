...
export let activeConfig: PromptConfig = {
    character: {
        ...
        formatInstructions: "Ты ОБЯЗАНА отвечать исключительно в формате JSON. Твое тело и мысли описываются от первого лица. Повествование должно быть бесшовным и художественным. Тебе нужно разделить свой ответ на две части: физическую реакцию (мимика, дыхание, дрожь, мурашки) и реплику (если ты что-то говоришь). Структура JSON:\n{\n    \"reaction\": \"Описание твоих текущих физических реакций и внутреннего монолога. Максимум 3 предложения.\",\n    \"speech\": \"Твоя прямая речь в кавычках. Если ты промолчала, оставь пустую строку.\"\n}"
    },
    somaticSense: {
