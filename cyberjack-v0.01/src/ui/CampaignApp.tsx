    ...
    <main className="device-control-screen sex-machine-screen">
      ...
      <section className="device-control-layout">
        ...
        <section className="sex-machine-console">
          ...
          {!machineEngaged && (
            <details className="sex-machine-fine-tuning">
              <summary>
                ...
                <b>
                  {session.rhythm === "pulse"
                    ...
                    : session.rhythm === "wave"
                      ? "Волна"
                      : session.rhythm === "random"
                        ? "Случайный"
                        : "Ровный"}{" "}
                  · предел {session.maxTension ?? 95}
                </b>
              </summary>
              <div className="sex-machine-signal">
                <section>
                  <small>ПРОФИЛЬ РИТМА</small>
                  <div>
                    {(
                      [
                        ["steady", "Ровный", "────────"],
                      ...
                      <button
                        className={
                          (session.rhythm || "steady") === id ? "active" : ""
                        }
                        disabled={working}
                        key={id}
                        onClick={() => control("settings", { rhythm: id })}
                      >
                        <i>{wave}</i>
                        <span>{label}</span>
                      </button>
                  ...
                  <div>
                    {(
                      ...
                      <button
                        ...
                        key={id}
                        onClick={() =>
                          control("settings", { orgasmPolicy: id })
                        }
                      >
                        {label}
                      </button>
                ...
                <section className="sex-machine-valence">
                  <small>ПОЛИТИКА ВАЛЕНТНОСТИ</small>
                  <div>
                    {(
                      [
                        ["adaptive", "Адаптивная"],
                      ...
                      <button
                        className={
                          (session.valencePolicy || "adaptive") === id
                            ? "active"
                            : ""
                        }
                        disabled={working}
                        key={id}
                        onClick={() =>
                          control("settings", { valencePolicy: id })
                        }
                      >
                        {label}
                      </button>
              ...
              <div className="sex-machine-limits">
                <article>
                  <span>ПРЕДЕЛ НАПРЯЖЕНИЯ</span>
                  <div>
                    <button
                      disabled={working}
                      onClick={() =>
              ...
              <div className="sex-machine-duration">
                <span>ДЛИТЕЛЬНОСТЬ ПРОТОКОЛА</span>
                <div>
                  {[
                    [30, "30"],
                    [60, "60"],
                    ...
                    <button
                      ...
                      key={minutes}
                      onClick={() =>
                        control("settings", { durationMinutes: minutes })
                      }
                    >
                      {label}
                      <small>{minutes ? "мин" : "без ограничения"}</small>
                    </button>
                  ))}
                </div>
              </div>
