...
import { buy, changeRole, controlEquipment, controlTimeFlow, getScenario, getTimeFlow, moveLaboratoryCharacter, passTime, recruit, travel, useEquipment } from '../controllers/scenarioController';
...
router.post('/scenario/characters/:characterId/move', moveLaboratoryCharacter as any);
...
router.get('/scenario/time/flow', getTimeFlow as any);
router.post('/scenario/time/flow', controlTimeFlow as any);
