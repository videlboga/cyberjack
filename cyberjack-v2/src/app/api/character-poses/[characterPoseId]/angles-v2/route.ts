...
// GET /api/character-poses/[characterPoseId]/angles-v2 - получить ракурсы позы персонажа (новая версия)
...
// POST /api/character-poses/[characterPoseId]/angles-v2 - создать новый ракурс для позы персонажа
