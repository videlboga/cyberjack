// Тест ИИ-триггера с чистым чатом
...
async function testAITriggerClean() {
  console.log('🎯 Тест ИИ-триггера с чистым чатом\n');
  ...
  try {
    ...
    // 2. Выполняем много действий, чтобы сработал ИИ-триггер
