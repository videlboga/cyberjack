...
async function testFrequentTriggers() {
  console.log('🎯 Тест частых ИИ-триггеров (каждые 5 применений)\n');
  ...
  try {
    ...
    // 2. Выполняем 10 действий для проверки триггеров
    console.log('\n🎯 Выполняем 10 действий для проверки триггеров...');
